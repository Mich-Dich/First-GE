...
// define the main keys on keyboard
typedef enum keys {
...
// keyboard input
GLUTTONY_API bool8 Input_is_key_down(keys key);
GLUTTONY_API bool8 Input_is_key_up(keys key);
GLUTTONY_API bool8 Input_was_key_down(keys key);
GLUTTONY_API bool8 Input_was_key_up(keys key);

void Input_process_key(keys key, bool8 pressed);

// mouse input
GLUTTONY_API bool8 Input_is_button_down(buttons button);
GLUTTONY_API bool8 Input_is_button_up(buttons button);
GLUTTONY_API bool8 Input_was_button_down(buttons button);
GLUTTONY_API bool8 Input_was_button_up(buttons button);
GLUTTONY_API void Input_get_mouse_position(int32* x, int32* y);
GLUTTONY_API void Input_get_previous_mouse_position(int32* x, int32* y);
