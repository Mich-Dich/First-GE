    ...
    LRESULT CALLBACK win32ProcessMessage(HWND hwnd, u32 msg, WPARAM w_param, LPARAM l_param) {
        ...
        switch (msg) {
            ...
            case WM_MOUSEMOVE: {
                ...
                Input_process_mouse_move(PosX, PosY);
            ...
            case WM_MOUSEWHEEL: {
                ...
                if (zDelta != 0) {
                    ...
                    zDelta = (zDelta < 0) ? -1 : 1;     // Flatten given amount to abs(1) (OS independent)
            ...
            case WM_LBUTTONUP: {
                ...
                //mouse_buttons loc_button = BU_LEFT;
                Input_process_button(BU_LEFT, pressed);
            ...
            case WM_MBUTTONUP: {
                ...
                bool8 pressed = (msg == WM_LBUTTONDOWN || msg == WM_MBUTTONDOWN || msg == WM_RBUTTONDOWN);
                //mouse_buttons loc_button = BU_MIDDLE;
                Input_process_button(BU_MIDDLE, pressed);
            ...
            case WM_RBUTTONUP: {
                ...
                bool8 pressed = (msg == WM_LBUTTONDOWN || msg == WM_MBUTTONDOWN || msg == WM_RBUTTONDOWN);
                //mouse_buttons loc_button = BU_RIGHT;
                Input_process_button(BU_RIGHT, pressed);
